...
export default function TradingPackage() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (Array.isArray(data)) {
          ...
          console.error("Error fetching packages: response is not an array:", data);
          setPackages([]);
        }
      } catch (error) {
    ...
    if (!token) {
      toast.warning(
        <div className="flex flex-col space-y-1">
          ...
          <Link href="/login" className="text-sm text-primary underline hover:opacity-80">
            Go to Login
          </Link>
        </div>
      );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {isFetching ? (
          ...
          <div className="col-span-full text-center py-12 text-muted-foreground">
            No active trading packages available at this time.
          </div>
        ) : (
          packages.map((pkg, i) => (
            <motion.div
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-between items-center text-xs text-muted-foreground">
                  ...
                  <span>Min: {pkg.minHoldingPeriod} {pkg.minHoldingPeriodUnit}</span>
                </div>
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                ...
                <div className="space-y-1 border-l border-white/5 pl-4">
                  ...
                  <p className="text-sm font-bold text-primary">+{selectedPackage.returnPercentage}%</p>
                </div>
                <div className="space-y-1 pt-2 border-t border-white/5">
                  <p className="text-[10px] font-medium text-muted-foreground uppercase">Holding Period</p>
                ...
                <div className="space-y-1 pt-2 border-t border-white/5 border-l pl-4">
                  <p className="text-[10px] font-medium text-muted-foreground uppercase">Daily Insights</p>
                  <p className="text-sm font-bold text-foreground">
                    {selectedPackage.dailyInsights ? "Supported" : "Not Provided"}
                  </p>
                </div>
              </div>
